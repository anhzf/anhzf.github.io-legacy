const classStyle = {
    ...
    navbar__item: 'md:inline-block hidden my-3 mx-2 py-1 px-4 font-montserrat font-bold text-blue-400 uppercase rounded-full hover:bg-blue-400 hover:text-white transition-colors duration-75 ease-in',
    ...
    headerBanner__photo: 'w-full self-end lg:col-span-3 md:col-span-5 sm:col-span-2 col-span-3 lg:col-start-2 col-start-1',
    headerBanner__content: 'lg:static absolute right-0 h-full lg:text-left text-right flex flex-col justify-center lg:col-span-7 md:col-span-9',
    headerBanner__content__title1: 'm-0 font-medium xl:text-4xl lg:text-3xl sm:text-xl text-md text-gray-500',
    headerBanner__content__title2: 'm-0 md:p-0 px-2 py-1 font-montserrat font-bold xl:text-5xl lg:text-4xl sm:text-2xl text-xl truncate md:bg-clip-text md:text-transparent md:bg-gradient-to-r md:from-teal-900 md:via-blue-800 md:to-blue-600 text-white bg-blue-500 bg-opacity-75 rounded-lg md:shadow-none shadow-lg',
