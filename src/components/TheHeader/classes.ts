const classStyle = {
    ...
    headerBanner__content: 'flex flex-col justify-center lg:col-span-7 col-span-8',
    headerBanner__content__title1: 'm-0 font-epilogue font-medium xl:text-4xl text-3xl text-gray-500',
    headerBanner__content__title2: 'm-0 font-montserrat font-bold xl:text-5xl text-4xl bg-clip-text text-transparent bg-gradient-to-r from-teal-900 to-blue-500 via-blue-800 to-blue-600',
