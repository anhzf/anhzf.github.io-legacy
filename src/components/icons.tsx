...
export function Instagram({ ...attrs }) {
    const defaultClass = 'h-4';
    const {
        className = defaultClass,
        title = 'Code',
    ...
    return (
        <svg viewBox="0 0 24 24" className={className} {...restAttrs}>
            <title>{title}</title>
...
export function Facebook({ ...attrs }) {
    const defaultClass = 'h-4';
    const {
        className = defaultClass,
        title = 'Code',
...
export function Whatsapp({ ...attrs }) {
    const defaultClass = 'h-4';
    const {
        className = defaultClass,
        title = 'Code',
